...
function crearTablasConfig() {
	...
	crearAdminvar('_DIRCURSOS','data/');
	crearAdminvar('_OCULTO',0);
	crearAdminvar('_ADMINDEF','estadisticas');
	crearAdminvar('_ADMINPASS','#Admin1');
	crearAdminvar('_MOODLEALLUSERS',0);
